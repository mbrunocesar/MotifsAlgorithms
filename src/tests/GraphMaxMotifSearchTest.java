...
public class GraphMaxMotifSearchTest {
	...
	public void exampleTreeTest() {
		...
		GraphBuilder builder = new GraphBuilder(graphColors);
	...
	public long basicTestSteps(GraphBuilder builder, int[] motifData) {
		// Starter
